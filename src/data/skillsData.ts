...
export const skillsData: ISkill[] = [
  ...
  { title: 'Astro', icon: SiAstro, color: '#BC52EE' },
  ...
  { title: 'Storybook', icon: SiStoryblok, color: '#FF4785' },
  { title: 'Azure B2C', color: '#0078D7' },
  { title: 'Azure Pipelines', icon: SiAzurepipelines, color: '#2560E0' },
  // { title: 'PrimeVue', color: '#4E8EE1' },
]
