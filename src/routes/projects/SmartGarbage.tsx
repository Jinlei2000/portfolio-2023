  ...
  return (
    <div className="bg-white dark:bg-own-neutral-900">
      ...
      <main className="pt-[52px] lg:pt-[68px]">
        <div className="mx-auto flex max-w-screen-md flex-col gap-6 px-4 md:px-6 lg:max-w-screen-lg">
          {/* Header */}
        ...
        {/* Technologies */}
        <div className="mt-32 flex flex-col gap-12 rounded-t-own-lg bg-own-neutral-50 py-6 dark:bg-own-neutral-800 sm:py-[52px] md:rounded-t-[40px] lg:rounded-t-[60px] lg:py-[68px] xl:rounded-t-[80px]">
